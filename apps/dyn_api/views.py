...
class DynamicAPI(APIView):
    ...
    def get(self, request, **kwargs):
        ...
        try:
            if model_id is not None:
                ...
                try:
                    ...
                    return Response(
                        data={"message": "Input Error = " + str(e), "success": False},
                        status=400,
                    )

                thing = get_object_or_404(
                    Utils.get_manager(DYNAMIC_API, kwargs.get("model_name")),
                    id=model_id,
                )
        ...
        return Response(data={"data": output, "success": True}, status=200)
    ...
    def post(self, request, **kwargs):
        try:
            ...
            if model_serializer.is_valid():
                ...
                return Response(
                    data={**model_serializer.errors, "success": False}, status=400
                )
        except KeyError:
            return Response(
                data={
        ...
        return Response(
            data={"message": "Record Created.", "success": True}, status=200
        )
    ...
    def put(self, request, **kwargs):
        try:
            ...
            model_serializer = Utils.get_serializer(
                DYNAMIC_API, kwargs.get("model_name")
            )(instance=thing, data=request.data, partial=True)
            if model_serializer.is_valid():
                model_serializer.save()
            else:
                return Response(
        ...
        return Response(
            data={"message": "Record Updated.", "success": True}, status=200
        )
    ...
    def delete(self, request, **kwargs):
        ...
        return Response(
            data={"message": "Record Deleted.", "success": True}, status=200
        )
